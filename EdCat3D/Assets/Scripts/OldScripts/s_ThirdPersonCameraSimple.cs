...
[System.Serializable]
public partial class s_ThirdPersonCameraSimple : MonoBehaviour
{
    public Transform cameraTransform;
    private Transform _target;
    // The distance in the x-z plane to the target
    public float distance;
    //var distance = Global._CameraPos;
    ...
    private bool snap;
    private s_ThirdPersonControllerSimple controller;
    ...
    public virtual void Awake()
    {
        ...
        if (this._target)
        {
            this.controller = (s_ThirdPersonControllerSimple) this._target.GetComponent(typeof(s_ThirdPersonControllerSimple));
        }
        if (this.controller)
        {
        ...
        {
            Debug.Log("Please assign a target to the camera that has a s_ThirdPersonControllerSimple script attached.");
        }
    ...
    public virtual void Apply(Transform dummyTarget, Vector3 dummyCenter)//SetUpRotation(targetCenter, targetHead);
    {
        ...
        //targetHeight = targetCenter.y + Global._CameraPos;
        // Damp the height
        float currentHeight = this.cameraTransform.position.y;
        //var currentHeight = Global._CameraPos;
        //currentHeight = Mathf.SmoothDamp (currentHeight, targetHeight, heightVelocity, heightSmoothLag);
        currentHeight = Mathf.SmoothDamp(currentHeight, currentHeight, ref this.heightVelocity, this.heightSmoothLag);
        //currentHeight = Global._CameraPos;
        ...
        {
            float _160 = // Set the height of the camera
            currentHeight;
            Vector3 _161 = this.cameraTransform.position;
            _161.y = _160;
            this.cameraTransform.position = _161;
        }
    }
    ...
    public s_ThirdPersonCameraSimple()
    {
        this.distance = 10f + Global._CameraPos;
        this.height = 8f + Global._CameraPos;
