...
public partial class s_ThirdPersonControllerSimple : MonoBehaviour
{
    ...
    public virtual void ApplyGravity()//verticalSpeed -= gravity * Time.deltaTime;
    {
    ...
    public s_ThirdPersonControllerSimple()
    {
