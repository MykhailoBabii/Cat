...
public class CoroutineManager : MonoBehaviour
{
    ...
    private IEnumerator DelayedActionInner(float delay, System.Action action, int times = 1)
    {
    ...
    public static void DelayedAction(float delay, System.Action action, int times = 1)
    {
        _instance.StartCoroutine(_instance.DelayedActionInner(delay, action, times));
    }
